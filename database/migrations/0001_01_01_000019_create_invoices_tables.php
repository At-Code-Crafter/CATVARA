...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('invoices', function (Blueprint $table) {
            ...
            $table->foreign('shipping_customer_id', 'inv_ship_customer_fk')->references('id')->on('customers')->nullOnDelete();
            ...
            $table->foreign('tax_group_id', 'inv_tax_group_fk')->references('id')->on('tax_groups')->nullOnDelete();
