          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3 text-sm">
            ...
            <li>
              <a href="{{ company_route('inventory.warehouses.index') }}"
                class="text-slate-500 hover:text-brand-600 transition-colors">Warehouses</a>
            </li>
            <li><i class="fas fa-chevron-right text-slate-300 text-xs"></i></li>
            <li aria-current="page">
              <span class="font-medium text-slate-400">{{ isset($warehouse) ? 'Edit' : 'Create' }}</span>
            </li>
          </ol>
        </nav>
        <h1 class="text-2xl font-black text-slate-900 tracking-tight">
          {{ isset($warehouse) ? 'Edit Warehouse: ' . $warehouse->name : 'Create New Warehouse' }}
        </h1>
        <p class="text-sm text-slate-500 font-medium mt-1">Manage distribution centers and stock locations.</p>
      </div>

      {{-- Top Actions --}}
      <div class="flex items-center gap-3">
        <a href="{{ company_route('inventory.warehouses.index') }}" class="btn btn-secondary">
          Cancel
        </a>
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
              <h3 class="font-bold text-slate-800 flex items-center gap-2">
                <i class="fas fa-warehouse text-brand-400"></i> Basic Information
              </h3>
            </div>
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="md:col-span-2">
                <label for="name"
                  class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Warehouse Name <span
              ...
              <div>
                <label for="code"
                  class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Warehouse Code <span
                    class="text-red-500">*</span></label>
          ...
          <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-100 bg-slate-50/50">
              <h3 class="font-bold text-slate-800 flex items-center gap-2">
                <i class="fas fa-map-marker-alt text-brand-400"></i> Facility Location
              </h3>
            </div>
            <div class="p-6">
              <label for="address" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Full
                Address</label>
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="p-6">
              <div class="flex items-center justify-between">
                <span class="flex flex-col">
                  <span class="font-bold text-slate-700 text-sm">Warehouse Active</span>
                  <span class="text-xs text-slate-400">Enable stock operations</span>
                </span>
          ...
          <div class="bg-blue-50/50 rounded-2xl border border-blue-100 p-6">
            <div class="flex items-start gap-3">
              ...
              <div>
                <h4 class="font-bold text-blue-800 text-sm">Warehouse Management</h4>
                <p class="text-xs text-blue-600 mt-1 leading-relaxed">
                  Warehouses are central storage hubs. They are used for receiving shipments and distributing stock to
                  stores.
                </p>
              </div>
            </div>
