  ...
  <div class="max-w-5xl mx-auto" id="import-app">
    ...
    <div id="step-4" class="step-content hidden animate-fade-in">
      <div class="card p-12 flex flex-col items-center justify-center text-center">
        ...
        <p id="completion-text" class="text-slate-500 max-w-sm mb-10">We've successfully imported your customers.</p>
    ...
    <script>
        ...
        fetch('{{ company_route('customers.import.upload') }}', {
          ...
          .then(data => {
            ...
            if (data.success) {
              ...
              // fileData.price_channels = data.price_channels || []; // Not used in Customer Import
              // fileData.locations = data.locations || []; // Not used
              renderStep2();
              changeStep(2);
            } else {
      ...
      function validateMapping() {
        ...
        Swal.fire({
          ...
          text: 'Identifying Names, Emails, and Addresses',
          didOpen: () => {
            Swal.showLoading();
          }
        });
