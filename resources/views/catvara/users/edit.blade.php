...
@section('content')
  <div class="space-y-8 animate-fade-in">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
      <div>
        <h2 class="text-3xl font-bold text-slate-800 tracking-tight">Edit User</h2>
        <p class="text-slate-400 text-sm mt-1 font-medium">Update account details and access level for
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-4 space-y-6">
          ...
          <div class="p-6 bg-brand-50/50 border border-brand-100/50 rounded-2xl">
            <div class="flex gap-3">
              ...
              <div class="space-y-2">
                <p class="text-xs font-bold text-slate-800">Security Tip</p>
                <p class="text-[10px] leading-relaxed text-slate-500 font-medium">
                  Leave the password field blank if you do not wish to change it. Ensure the user is notified if
        ...
        <div class="lg:col-span-8 space-y-6">
          <div class="card border-slate-100 bg-white shadow-soft overflow-hidden">
            <div class="p-6 border-b border-slate-50 bg-slate-50/20">
              <h3 class="text-xs font-bold text-slate-800 uppercase tracking-widest flex items-center gap-2">
                <i class="fas fa-user-edit text-brand-400"></i> Account Details
              </h3>
            </div>
            <div class="p-8">
                ...
                <div class="space-y-1.5">
                  ...
                  <select name="user_type"
                    ...
                    <option value="SUPER_ADMIN"
                      {{ old('user_type', $user->user_type) === 'SUPER_ADMIN' ? 'selected' : '' }}>SUPER ADMIN</option>
                  </select>
                </div>
