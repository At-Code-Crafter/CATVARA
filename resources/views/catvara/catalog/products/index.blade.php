            ...
            <div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-6">
                ...
                <div class="space-y-1.5">
                    <label for="filter_stock"
                        class="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">Stock
                        Level</label>
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="input-icon-group group date-range-fix">
                        <i
                            class="far fa-calendar-alt text-slate-400 group-focus-within:text-brand-400 transition-colors"></i>
                        <input type="text" id="filter_date_range" class="w-full pl-10"
                            placeholder="Select date range...">
                    </div>
                </div>
                <div class="space-y-1.5 flex flex-col justify-end">
                    <label class="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">Brand Status</label>
                    <label for="filter_inactive_brand"
                        ...
                        <div class="relative">
                            <input type="checkbox" id="filter_inactive_brand" class="sr-only peer">
            ...
            const table = $('#productsTable').DataTable({
                ...
                `;
                    ...
                    },
                    {
                        ...
                        render: (data) => data !== '—' ?
                            `<span class="text-brand-600">{{ request()->company->baseCurrency->symbol ?? '$' }}</span>${data}` :
                            data
                    },
                    {
                        data: 'status',
