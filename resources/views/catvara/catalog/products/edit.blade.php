      ...
      <div class="lg:col-span-8 space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-soft border border-slate-100 overflow-hidden">
          <div class="p-6 border-b border-slate-50 bg-slate-50/30 flex items-center justify-between">
            ...
            <span
              class="px-3 py-1 bg-slate-100 text-slate-600 text-[10px] font-bold uppercase rounded-md border border-slate-200">Currency:
                      ...
                      <div class="flex items-center gap-3">
                        <label class="relative inline-flex items-center cursor-pointer">
                          <input type="checkbox" name="variants[{{ $variant->id }}][is_active]" value="1"
                            class="sr-only peer" {{ $variant->is_active ? 'checked' : '' }}>
                          <div
          ...
          <div class="divide-y divide-slate-50">
            <a href="{{ company_route('inventory.index') }}"
              ...
              <span class="text-sm font-medium text-slate-600 group-hover:text-brand-600"><i
                  class="fas fa-boxes mr-3 text-slate-400 group-hover:text-brand-500"></i> Stock Levels</span>
              <i
            ...
            <a href="#" class="flex items-center justify-between p-4 hover:bg-slate-50 transition-colors group">
              <span class="text-sm font-medium text-slate-600 group-hover:text-brand-600"><i
                  class="fas fa-history mr-3 text-slate-400 group-hover:text-brand-500"></i> Audit Logs</span>
              <i
                class="fas fa-chevron-right text-[10px] text-slate-300 group-hover:translate-x-1 transition-transform"></i>
            </a>
          </div>
