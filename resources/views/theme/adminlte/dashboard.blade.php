            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="date-filter-wrapper">
                        <form id="dateFilterForm" method="GET" action="{{ company_route('company.dashboard') }}" class="d-flex flex-wrap align-items-center gap-2">
                            {{-- Quick Presets --}}
                            <div class="btn-group mr-2" role="group">
                                <button type="button" class="btn btn-filter-preset {{ !request('date_from') ? 'active' : '' }}" data-preset="all">
                                    All Time
                                </button>
                ...
                <div class="mt-2">
                    <span class="badge badge-filter-active">
                        ...
                        Filtered: {{ request('date_from') ? \Carbon\Carbon::parse(request('date_from'))->format('M d, Y') : 'Start' }}
    ...
    <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mb-4">
        <a href="{{ company_route('catalog.products.index') }}" class="text-decoration-none">
            <div class="status-card status-primary">
                ...
                <div class="status-value">{{ number_format($stats['active_products'] ?? 0) }}<small>/{{ $stats['total_products'] ?? 0 }}</small></div>
...
<style>
    ...
    /* Metric Card Colors */
    .metric-blue .metric-icon { background: rgba(59, 130, 246, 0.15); color: #3b82f6; }
    .metric-blue .metric-value { color: #1e40af; }
    .metric-blue .metric-footer { color: #3b82f6; }

    .metric-green .metric-icon { background: rgba(16, 185, 129, 0.15); color: #10b981; }
    .metric-green .metric-value { color: #065f46; }
    .metric-green .metric-footer { color: #10b981; }

    .metric-orange .metric-icon { background: rgba(245, 158, 11, 0.15); color: #f59e0b; }
    .metric-orange .metric-value { color: #92400e; }
    .metric-orange .metric-footer { color: #f59e0b; }

    .metric-purple .metric-icon { background: rgba(139, 92, 246, 0.15); color: #8b5cf6; }
    .metric-purple .metric-value { color: #5b21b6; }
    .metric-purple .metric-footer { color: #8b5cf6; }
    ...
    .status-warning .status-value { color: #92400e; }

    .status-success { border-left-color: #10b981; }
    .status-success .status-icon { color: #10b981; }
    .status-success .status-value { color: #065f46; }

    .status-info { border-left-color: #06b6d4; }
    .status-info .status-icon { color: #06b6d4; }
    .status-info .status-value { color: #0e7490; }

    .status-primary { border-left-color: #3b82f6; }
    .status-primary .status-icon { color: #3b82f6; }
    .status-primary .status-value { color: #1e40af; }

    .status-dark { border-left-color: #475569; }
    .status-dark .status-icon { color: #475569; }
    .status-dark .status-value { color: #1e293b; }

    .status-secondary { border-left-color: #64748b; }
    .status-secondary .status-icon { color: #64748b; }
    .status-secondary .status-value { color: #334155; }
    ...
    .action-success:hover { color: #fff; }

    .action-info {
        background: linear-gradient(135deg, #2193b0 0%, #6dd5ed 100%);
        color: #fff;
    }
    .action-info:hover { color: #fff; }

    .action-warning {
        background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);
        color: #fff;
    }
    .action-warning:hover { color: #fff; }
</style>
@endpush
