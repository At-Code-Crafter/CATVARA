...
@section('content')
  <div class="container-fluid pos-shell">
        <ul class="nav nav-tabs pos-steps" id="order-tabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link"href="{{ company_route('pos.orders.create') }}">
              <i class="fas fa-user mr-2"></i> 1. Customer
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" id="step2-tab" data-toggle="pill" data-bs-toggle="pill" href="#step2"
    ...
    <div class="card ent-card">
      ...
      <div class="card-body p-4">
        <div class="tab-content" id="order-tabs-content">
          ...
          <div class="tab-pane fade active" id="step2" role="tabpanel" aria-labelledby="step2-tab">
            <div class="row">
              <div class="col-md-8">
                <div class="card ent-card">
                  <div class="card-body">
