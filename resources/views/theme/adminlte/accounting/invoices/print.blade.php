            ...
            <div class="invoice-page">
                ...
                <div class="inv-top {{ $page['is_first'] ? 'has-divider' : '' }}">
                    ...
                    <div class="inv-meta-block inv-top-right">
                        ...
                        <div class="value">{{ number_format($invoice->grand_total, 2) }}
                            {{ $invoice->currency->code ?? '' }}</div>
                    </div>
                </div>
                    ...
                    <div class="inv-mid">
                        ...
                        <div class="inv-dates">
                            ...
                            <div class="row">
                                ...
                                <div class="value">{{ $invoice->due_date ? $invoice->due_date->format('F d, Y') : '-' }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="totals-area">
                        <div class="totals">
                            ...
                            <div class="trow total">
                                ...
                                <div class="val">{{ number_format($invoice->grand_total, 2) }}
                                    {{ $invoice->currency->code ?? '' }}</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="inv-footer">
                    <div class="left">Provided by: {{ $invoice->company->name }}<br>VAT ID:
                        {{ $invoice->company->detail->tax_number ?? 'N/A' }}</div>
                    <div class="right">Issued on {{ $invoice->issued_at->format('F d, Y') }}<br>Page {{ $pageNo }}
                        of {{ $totalPages }} for {{ $invoice->invoice_number }}</div>
                </div>
            </div>
        @endforeach
    </div>
